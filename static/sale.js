...
$("#state").change(function(){
	$("#place_of_supply").val($("#state").val());
	$.get("/states/", function(states){
		$("#state_name").val(states[$("#state").val()].name);
		$("#place_of_supply_name").val(states[$("#states").val()].name);
	});
});
...
$.get("/states/", function(states){
		$("#place_of_supply_name").val(states[$("#place_of_supply2").val()].name);
	});


$("#consignee_state").change(function(){
	$.get("/states/", function(states){
		$("#consignee_state_name").val(states[$("#consignee_state").val()].name);
	});
});
