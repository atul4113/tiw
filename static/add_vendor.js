			...
			$.ajax({
				...
				success: function(result){
					...
					if (result == 1) {
						...
						$("#err").html("Vendor added successfully! You can continue adding more.");
						$("#form")[0].reset()
						$('html,body').scrollTop(0);
						items = [];
						added = [];
						console.log(items);
						$("#item_list").html('<tr class="row"> <th class="col-xs-6">Item Name</th> <th class="col-xs-6">Item code</th><th></th></tr>');
					}
					if (result == 0) {	
